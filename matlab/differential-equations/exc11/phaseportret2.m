...
tmax = 50;
% пет от шестте основни случая за равновесна точка

% б) asimptotichno ustoichiva
% A = [-1, 0; 0, -2]; b = [-1; -6];

% в) неустойчив фокус
%A = [4, 1; -2, 2]; b = [-5; 0];

% г) устойчив фокус при фазови криви: спирали
%A = [-5, 1; -18, 1]; b = [0; 0];

% д) център, устойчив по Лябунов
%A = [-2, -4; 2, 2]; b = [0; -2];

% e) седло, фазови криви = хиперболи
A = [1, 2; 4, 3]; b = [1; -1];
